...
import_directory = 'B-Dot_Data/raw' #Saved as a subfile so the singular directory entry should be fine. File specificication will require manual input.
...
def show_selection(): #Collects gui selection and saves filename as a string for loading on line 32
...
data_frame = pd.read_csv(selected_result['file_path'])
